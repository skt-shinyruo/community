...
- runbooks：新增内容渲染迁移与网关采集排障手册（`.helloagents/modules/runbooks/content-rendering-migration.md`、`.helloagents/modules/runbooks/gateway-analytics-collect.md`）。
...
- 安全检查：`scripts/security-check.sh` + 方案包报告 `.helloagents/archive/2026-01/202601170935_legacy_cutover_prod_parity/security-check.md`。
...
- 新增并归档“Boot 3 + Java 17 + Vue3 + Nacos 微服务化拆分”方案包：`.helloagents/archive/2026-01/202601161428_boot3_ms_vue3_nacos/`。
