...
Directory: `.helloagents/archive/2026-01/202601171622_ui_rebuild_parity/`
...
- [√] 12.1 更新 `.helloagents/api.md`：补充 UI 依赖 API 与权限说明（ADMIN/MODERATOR）
- [√] 12.2 新增/更新 `.helloagents/modules/frontend.md`：记录前端 IA、组件库与路由规范
