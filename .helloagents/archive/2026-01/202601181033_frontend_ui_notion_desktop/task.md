...
Directory: `.helloagents/archive/2026-01/202601181033_frontend_ui_notion_desktop/`
...
## 4. Security Check
- [√] 4.1 执行前端安全检查（输入校验、错误提示、token 不落盘、XSS 风险不升级），记录检查点：`.helloagents/archive/2026-01/202601181033_frontend_ui_notion_desktop/how.md`

## 5. Documentation Update
- [√] 5.1 同步更新知识库（frontend 模块文档 + 设计系统说明）：`.helloagents/modules/frontend.md`
- [√] 5.2 更新变更记录：`.helloagents/CHANGELOG.md`

## 6. Testing
- [√] 6.1 执行前端单测与构建：`npm -C frontend test`、`npm -C frontend run build`
- [?] 6.2 冒烟验证关键路由（posts/detail/search/messages/notices/settings/auth），并记录结果到 `.helloagents/archive/<YYYY-MM>/.../task.md`
