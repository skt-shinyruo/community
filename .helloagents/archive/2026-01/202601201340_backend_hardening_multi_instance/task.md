...
Directory: `.helloagents/archive/2026-01/202601201340_backend_hardening_multi_instance/`
...
- [√] 2.2 增加一个最小“登录态回归”E2E/手工用例说明（避免后续改动破坏 cookie 行为），verify why.md#r1s1-fe-gateway-cookie-login-refresh, docs: `docs/SECURITY.md` 或 `.helloagents/api.md`
...
- [√] 12.1 更新 `.helloagents/modules/*`：补齐 internal API、调用链路、Kafka/DLQ 约定与运维说明
