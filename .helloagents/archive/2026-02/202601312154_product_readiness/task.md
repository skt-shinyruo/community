...
Directory: `.helloagents/archive/2026-01/202601312154_product_readiness/`
...
- [√] 7.1 更新知识库（auth onboarding）：file: `.helloagents/modules/auth-service.md`, verify why.md#requirement-r1-onboarding
- [√] 7.2 更新知识库（avatar/files）：file: `.helloagents/modules/user.md`, verify why.md#requirement-r2-media
- [√] 7.3 更新知识库（batch likes & feed）：file: `.helloagents/modules/social.md`, verify why.md#requirement-r3-feed
- [√] 7.4 更新知识库（gateway /files 路由）：file: `.helloagents/modules/gateway.md`, verify why.md#requirement-r2-media
- [√] 7.5 更新知识库（ops break-glass & console）：files: `.helloagents/modules/runbooks/internal-ops.md`, `.helloagents/modules/search.md`, verify why.md#requirement-r4-ops
- [√] 7.6 更新知识库（前端页面入口与权限矩阵）：file: `.helloagents/modules/frontend.md`, verify why.md#requirement-r5-role
...
- [√] 8.3 smoke：feed 列表请求预算检查（浏览器 network 验证步骤写入脚本/文档），file: `.helloagents/modules/runbooks/security.md` 或新增 runbook, verify why.md#scenario-r3-s1-request-budget
