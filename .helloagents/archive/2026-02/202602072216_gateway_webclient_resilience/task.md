...
Directory: `.helloagents/archive/2026-02/202602072216_gateway_webclient_resilience/`
...
- [√] 4.1 更新 `docs/DEPLOYMENT.md` 与 `.helloagents/modules/gateway.md`：补充 `gateway.webclient.*` 的含义、默认值、调参建议与观测指标
