...
Directory: `.helloagents/archive/2026-02/202602081447_remove_internal_auth/`
...
- [√] 9.5 更新 helloagents runbooks（移除或明确废弃 internal-token/ops guard 机制），files: `.helloagents/modules/runbooks/internal-ops.md`, `.helloagents/modules/runbooks/internal-token-rotation.md`
