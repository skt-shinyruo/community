...
Directory: `.helloagents/archive/2026-02/202602132020_internal_ops_dubbo_unification/`
...
- [√] 6.2 更新知识库：`.helloagents/api.md`、`.helloagents/modules/runbooks/internal-ops.md`、`.helloagents/modules/*`，移除 `/internal/**` 推荐路径并以 `/api/ops/**` + Dubbo 为 SSOT
