...
Directory: `.helloagents/archive/2026-02/202602212346_gateway_security_ssot/`
...
- [√] 4.1 更新架构与模块文档，移除 `legacy-matrix` 相关口径并明确 SSOT 策略，修改 `docs/ARCHITECTURE.md`、`.helloagents/modules/gateway.md`，verify why.md#requirement-gateway-security-ssot
...
- [√] 6.1 开发实现完成后，将方案包迁移到 `.helloagents/archive/YYYY-MM/` 并更新 `.helloagents/archive/_index.md`（按 G11），标记 task 状态
