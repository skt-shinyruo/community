...
Runbook：
- `.helloagents/modules/runbooks/content-rendering-migration.md`
...
## Data Models
### discuss_post
（详见 `.helloagents/data.md` 的 “discuss_post” 小节）

### category / tag / post_tag
（详见 `.helloagents/data.md` 的 taxonomy 小节：`category`、`tag`、`post_tag`）

### comment
（详见 `.helloagents/data.md` 的 “comment” 小节）

### report / moderation_action / post_bookmark / user_subscription_category
（详见 `.helloagents/data.md` 对应小节）
