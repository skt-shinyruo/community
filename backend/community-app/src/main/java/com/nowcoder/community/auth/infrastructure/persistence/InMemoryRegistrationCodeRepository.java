...
public class InMemoryRegistrationCodeRepository implements RegistrationCodeRepository {

    private final Map<UUID, Entry> store = new ConcurrentHashMap<>();
    private final int maxFailures;

    public InMemoryRegistrationCodeRepository() {
        this.maxFailures = 3;
    }

    @Autowired
    public InMemoryRegistrationCodeRepository(RegistrationProperties properties) {
