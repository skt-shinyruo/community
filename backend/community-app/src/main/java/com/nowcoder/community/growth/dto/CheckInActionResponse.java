...
public class CheckInActionResponse {
    ...
    public boolean isNewlyCheckedIn() {
        return newlyCheckedIn;
    }

    public void setNewlyCheckedIn(boolean newlyCheckedIn) {
        this.newlyCheckedIn = newlyCheckedIn;
    }
