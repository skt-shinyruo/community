...
public class CreateMarketListingRequest {
    ...
    @Valid
    private AddMarketInventoryBatchRequest inventory;
    ...
    public AddMarketInventoryBatchRequest getInventory() {
        return inventory;
    }

    public void setInventory(AddMarketInventoryBatchRequest inventory) {
