...
@Service
public class MarketWalletActionService {
    ...
    MarketWalletActionService(MarketWalletActionMapper mapper, UuidV7Generator idGenerator) {
        this.mapper = mapper;
    ...
    private String requestId(UUID orderId, String actionType) {
        return walletBizId(orderId) + ":" + actionType.toLowerCase(Locale.ROOT);
    }
