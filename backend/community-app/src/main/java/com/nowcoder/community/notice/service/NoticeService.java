...
public class NoticeService {
    ...
    public NoticeService(NoticeMapper noticeMapper) {
        this(noticeMapper, new UuidV7Generator());
    }

    NoticeService(NoticeMapper noticeMapper, UuidV7Generator idGenerator) {
        this.noticeMapper = noticeMapper;
        this.idGenerator = idGenerator;
    }

    public void createNotice(UUID toUserId, String topic, String contentJson) {
    ...
    public List<NoticeItemResponse> listNoticeItems(UUID userId, String topic, int page, int size) {
