...
class NoDistributedProjectionInfraArchTest {
    ...
    void backend_should_not_keep_runtime_kafka_or_distributed_outbox_projection_infrastructure() {
        ...
        Path mainRoot = backendRoot.resolve("community-app/src/main/java");
        assertThat(backendRoot.resolve("community-app/src/main/java/com/nowcoder/community/infra/kafka"))
