...
class DbRefreshTokenRepositoryTest {
    ...
    private DbRefreshTokenRepository newStore(long graceSeconds) {
        ...
        try {
            // Task 4 injects JwtProperties into DbRefreshTokenRepository.
            Constructor<DbRefreshTokenRepository> ctor = DbRefreshTokenRepository.class.getConstructor(
    ...
    void consume_whenConsumeFailsAndTokenWasRevokedOutsideGrace_shouldRevokeFamily() {
        DbRefreshTokenRepository store = newStore(10);
    ...
    void consume_shouldUseConfiguredGraceSeconds() {
        DbRefreshTokenRepository store = newStore(1);
