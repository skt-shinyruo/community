...
class PostCounterApplicationServiceTest {
    ...
    void readShouldRestoreViewSnapshotAndAuthoritativeBookmarkCountAfterCacheLoss() {
        ...
        PostCounterApplicationService recoveryService = new PostCounterApplicationService(
                postCounterCache,
                snapshotRepository,
                postRepository,
                likeQueryPort,
    ...
    void readShouldFallBackToPersistedAndOwnerFactsWhenRedisIsUnavailable() {
        ...
        LikeQueryPort likeQueryPort = mock(LikeQueryPort.class);
        BookmarkRepository bookmarkRepository = mock(BookmarkRepository.class);
        PostCounterApplicationService fallbackService = new PostCounterApplicationService(
                postCounterCache,
                snapshotRepository,
                postRepository,
                likeQueryPort,
    ...
    void bookmarkReconciliationShouldMarkDirtyAndClearOnlyMatchingSnapshotRevision() {
        ...
        PostCounterApplicationService reconciliationService = new PostCounterApplicationService(
                postCounterCache,
                snapshotRepository,
                null,
                null,
