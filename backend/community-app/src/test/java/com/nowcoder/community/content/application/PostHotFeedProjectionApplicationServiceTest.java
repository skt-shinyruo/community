...
class PostHotFeedProjectionApplicationServiceTest {
    ...
    void postUpdatedShouldRecomputeHotnessAndUpsertBothFeeds() {
        ...
        DiscussPost post = post(uuid(200), uuid(10), 7, 12.0);
    ...
    void postUpdatedShouldClearExistingBoardMembershipBeforeUpsertingCurrentBoard() {
        ...
        verify(postFeedCache).upsertBoardHot(uuid(13), uuid(203), 18.0, "hot-v1");
    }
    ...
    void socialLikeSignalShouldUseCurrentPostBoardWhenCommandBoardIdMissing() {
        ...
        DiscussPost post = post(uuid(202), uuid(12), 9, 20.0);
        ...
        verify(postFeedCache).upsertGlobalHot(uuid(202), 31.0, "hot-v1");
        verify(postFeedCache).upsertBoardHot(eq(uuid(12)), eq(uuid(202)), eq(31.0), eq("hot-v1"));
    }
    ...
    void postUpdatedShouldUseCurrentPersistedBoardWhenCommandBoardIdIsStale() {
        ...
        verify(postFeedCache).upsertBoardHot(eq(uuid(14)), eq(uuid(204)), eq(25.0), eq("hot-v1"));
    }
