...
class MarketOrderAutoConfirmerUnitTest {
    ...
    void confirmOneDueOrderShouldLockOrderMarkReleasePendingAndEnqueueRelease() {
        ...
        boolean confirmed = new MarketOrderAutoConfirmer(
        ...
        verify(marketWalletActionCoordinator).enqueueRelease(orderId, sellerUserId, buyerUserId, 1200L);
    }
    ...
    void confirmOneDueOrderShouldSkipOrdersThatAreNoLongerDue() {
        ...
        verify(marketWalletActionCoordinator, never()).enqueueRelease(
