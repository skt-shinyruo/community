...
class ReindexJobApplicationServiceTest {
    ...
    void tryStartShouldReturnAcquiredJobWhenDistributedLockSucceeds() {
        ...
        ReindexJobApplicationService service = new ReindexJobApplicationService(guard, Duration.ofMinutes(30));
        ReindexJobApplicationService.ReindexJob job = service.tryStart();
    ...
    void startRenewalShouldRefreshDistributedLockUsingCompareAndPexpireScript() {
        ...
        ReindexJobApplicationService service = new ReindexJobApplicationService(guard, ttl);
        ReindexJobApplicationService.ReindexJob job = new ReindexJobApplicationService.ReindexJob(
                "job-1",
                true,
        ...
        try (ReindexJobApplicationService.RenewalHandle ignored = service.startRenewal(job)) {
