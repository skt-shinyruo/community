...
@Service
public class EntityResolveApiImpl implements EntityResolveApi {

    private final DiscussPostMapper discussPostMapper;
    private final CommentMapper commentMapper;

    public EntityResolveApiImpl(DiscussPostMapper discussPostMapper, CommentMapper commentMapper) {
