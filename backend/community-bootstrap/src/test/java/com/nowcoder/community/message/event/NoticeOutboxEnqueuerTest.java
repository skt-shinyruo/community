...
class NoticeOutboxEnqueuerTest {
    ...
    void commentCreatedShouldEnqueueCommentNotice() throws Exception {
        ...
        enqueuer.onContentEvent(new ContentLocalEvent("evt-n1", ContentEventTypes.COMMENT_CREATED, payload));
    ...
    void followCreatedShouldEnqueueFollowNotice() throws Exception {
        ...
        enqueuer.onSocialEvent(new SocialLocalEvent("evt-n2", SocialEventTypes.FOLLOW_CREATED, payload));
    ...
    void commentCreatedShouldNotEnqueueWhenTargetUserIdMissing() {
        ...
        enqueuer.onContentEvent(new ContentLocalEvent("evt-n3", ContentEventTypes.COMMENT_CREATED, payload));
