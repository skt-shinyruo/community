...
class RendezvousWorkerSelectorTest {
    ...
    void shouldIgnoreDrainingWorkersForHealthySelection() {
        ...
        assertThat(registry.healthyWorkers()).extracting(WorkerDescriptor::id).containsExactly("worker-b");
    }
    ...
    void shouldPreferWorkerWithCapacityOverFullWorkerWithHigherHash() {
        ...
        assertThat(selected.id()).isEqualTo("worker-low-hash-available");
    }
    ...
    void shouldKeepRendezvousDistributionWhenAllKnownWorkersAreFull() {
        ...
        assertThat(selected.id()).isEqualTo("worker-a");
    }
