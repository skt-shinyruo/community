...
public record SendRoomTextFrame(
    ...
    public SendRoomTextFrame(String type, String clientMsgId, UUID roomId, String content) {
        this(type, clientMsgId, roomId, content, ImContractVersions.WS_FRAME_VERSION);
    }
