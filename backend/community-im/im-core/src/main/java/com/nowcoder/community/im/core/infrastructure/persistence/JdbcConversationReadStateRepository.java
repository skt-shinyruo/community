...
@Repository
public class JdbcConversationReadStateRepository implements ConversationReadStateRepository {

    private final JdbcTemplate jdbcTemplate;

    public JdbcConversationReadStateRepository(JdbcTemplate jdbcTemplate) {
