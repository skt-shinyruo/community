...
@Import({
        ...
        OssMetricsSecurityBlankCredentialsTest.WebMvcSliceJsonCodecTestConfig.class
})
class OssMetricsSecurityBlankCredentialsTest {
    ...
    @Test
    void blankMetricsPasswordShouldKeepApplicationOperableAndDenyPrometheus() throws Exception {
