...
@Service
public class EntityResolveRpcServiceImpl implements EntityResolveRpcService {

    private final DiscussPostMapper discussPostMapper;
    private final CommentMapper commentMapper;

    public EntityResolveRpcServiceImpl(DiscussPostMapper discussPostMapper, CommentMapper commentMapper) {
