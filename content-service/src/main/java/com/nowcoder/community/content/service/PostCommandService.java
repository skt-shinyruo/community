...
public class PostCommandService {
    ...
    public PostCommandService(PostService postService, PostScoreQueue postScoreQueue, ContentEventPublisher eventPublisher) {
    ...
    @Transactional
    public int createPost(int userId, String title, String content) {
