...
@SpringBootTest(properties = {
        "content.render.legacy-entity-unescape-enabled=true"
})
@AutoConfigureMockMvc
class PostRenderingCompatibilityEnabledTest {
    ...
    @Test
    void postDetailShouldUnescapeLegacyEntitiesWhenEnabled() throws Exception {
