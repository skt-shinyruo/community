...
values
  (x'00000000000070008000000000000001', 'aaa', '$2b$10$3.6YcPCzcRJuAETAOx1cWeYxrQ3BEp1iWUNUEfaD8h4p.F4f3LzIq', '', 'aaa@example.com', 0, 1, 'http://example.com/a.png', now(), 1, 1),
  (x'00000000000070008000000000000002', 'bbb', '$2b$10$3.6YcPCzcRJuAETAOx1cWeYxrQ3BEp1iWUNUEfaD8h4p.F4f3LzIq', '', 'bbb@example.com', 0, 1, 'http://example.com/b.png', now(), 2, 2),
  (x'00000000000070008000000000000003', 'admin', '$2b$10$3.6YcPCzcRJuAETAOx1cWeYxrQ3BEp1iWUNUEfaD8h4p.F4f3LzIq', '', 'admin@example.com', 1, 1, 'http://example.com/admin.png', now(), 3, 3)
