...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic analytics.request --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic analytics.request.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.private-persisted.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.room-persisted.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.private-committed.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.room-committed.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.private-rejected.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.room-rejected.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.room-member-changed.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 3
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.user-messaging-policy-changed.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
...
kafka-topics --bootstrap-server "${KAFKA_BOOTSTRAP_SERVERS}" --create --if-not-exists --topic im.event.user-block-relation-changed.dlq --replication-factor "${KAFKA_TOPIC_REPLICATION_FACTOR}" --partitions 12
