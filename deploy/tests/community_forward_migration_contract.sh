...
migration="deploy/mysql/community-migrations/V016__reliability_and_query_consistency.sql"
bounded_comment_migration="deploy/mysql/community-migrations/V017__bounded_comment_cleanup.sql"
social_like_post_migration="deploy/mysql/community-migrations/V018__social_comment_like_post_reference.sql"
market_wallet_recovery_migration="deploy/mysql/community-migrations/V019__market_wallet_recovery_schedule.sql"
im_policy_snapshot_migration="deploy/mysql/community-migrations/V020__im_policy_snapshot_version_history.sql"
growth_like_lifecycle_migration="deploy/mysql/community-migrations/V021__growth_like_lifecycle_state.sql"
bookmark_counter_reconciliation_migration="deploy/mysql/community-migrations/V022__durable_bookmark_counter_reconciliation.sql"
