...
1) **通用事件协议（contracts）：** `backend/community-bootstrap/src/main/java/com/nowcoder/community/contracts/event/`
- `backend/community-bootstrap/src/main/java/com/nowcoder/community/contracts/event/EventEnvelope.java`
- `backend/community-bootstrap/src/main/java/com/nowcoder/community/contracts/event/EventEnvelopeParser.java`
- `backend/community-bootstrap/src/main/java/com/nowcoder/community/contracts/event/UnknownEventAction.java`
- `backend/community-bootstrap/src/main/java/com/nowcoder/community/contracts/event/EventTopicConventions.java`

2) **域事件契约（生产方域 owns semantics，当前同模块内）：**
- content：`backend/community-bootstrap/src/main/java/com/nowcoder/community/content/api/event/ContentEventTypes.java` + `backend/community-bootstrap/src/main/java/com/nowcoder/community/content/api/event/payload/*`
- social：`backend/community-bootstrap/src/main/java/com/nowcoder/community/social/api/event/SocialEventTypes.java` + `backend/community-bootstrap/src/main/java/com/nowcoder/community/social/api/event/payload/*`
