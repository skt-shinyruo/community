...
1) **通用事件协议（中立 contracts）：** `backend/platform/contracts-event-core/`
- `backend/platform/contracts-event-core/src/main/java/com/nowcoder/community/contracts/event/EventEnvelope.java`
- `backend/platform/contracts-event-core/src/main/java/com/nowcoder/community/contracts/event/EventEnvelopeParser.java`
- `backend/platform/contracts-event-core/src/main/java/com/nowcoder/community/contracts/event/EventTopics.java`
- `backend/platform/contracts-event-core/src/main/java/com/nowcoder/community/contracts/event/UnknownEventAction.java`
- `backend/platform/contracts-event-core/src/main/java/com/nowcoder/community/contracts/event/EventTopicConventions.java`

2) **域事件契约（生产方域 owns semantics）：** `backend/*-service/.../api/`
- content：`backend/content-service/src/main/java/com/nowcoder/community/content/api/event/ContentEventTypes.java` + `backend/content-service/src/main/java/com/nowcoder/community/content/api/event/payload/*`
- social：`backend/social-service/src/main/java/com/nowcoder/community/social/api/event/SocialEventTypes.java` + `backend/social-service/src/main/java/com/nowcoder/community/social/api/event/payload/*`
