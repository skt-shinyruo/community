...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/403', name: 'forbidden', component: ForbiddenView, meta: routeMeta('forbidden', { title: '无权限', subtitle: '你当前没有访问这一页所需的权限。' }) },
    { path: '/:pathMatch(.*)*', name: 'notFound', component: NotFoundView, meta: routeMeta('notFound', { title: '未找到', subtitle: '当前地址没有对应内容。' }) }
  ]
})
