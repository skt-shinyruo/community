...
Directory: `helloagents/plan/202601181151_captcha_id_best_practice/`
...
- [√] 7.1 更新 `helloagents/wiki/api.md`（captcha JSON 协议 + 新 password reset API）
- [√] 7.2 更新 `helloagents/wiki/modules/auth-service.md` 与 `helloagents/wiki/modules/frontend.md`（验证码与交互说明）
