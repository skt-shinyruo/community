...
Directory: `helloagents/plan/202601231154_bbs_core_1to4_mvp/`
...
- [√] 8.1 更新 `helloagents/wiki/api.md`：补齐新增 API（reports/moderation/blocks/bookmarks/subscriptions/leaderboard）
- [√] 8.2 更新 `helloagents/wiki/modules/content.md`：补齐内容域新增表与接口约定
- [√] 8.3 更新 `helloagents/wiki/modules/user.md`：补齐积分/处罚状态与事件消费约定
- [√] 8.4 更新 `helloagents/wiki/modules/social.md`：补齐拉黑关系 API 与 Redis key 约定
