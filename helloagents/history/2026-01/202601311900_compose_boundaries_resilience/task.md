...
Directory: `helloagents/plan/202601311900_compose_boundaries_resilience/`
...
- [√] 5.3 Runbook：固化 DLQ 回放流程与风控（重复副作用/回放顺序/审计），files: `helloagents/wiki/runbooks/kafka-dlq-replay.md`, verify why.md#scenario-s2-消费失败进入-dlq-且可回放
