...
Directory: `helloagents/plan/202602022143_fix_known_issues/`
...
- [√] 7.1 更新模块文档：`helloagents/wiki/modules/content.md`（渲染契约/兼容开关/迁移建议）
- [√] 7.2 更新模块文档：`helloagents/wiki/modules/frontend.md`（受控渲染点位/最终一致提示）
- [√] 7.3 更新模块文档：`helloagents/wiki/modules/gateway.md`（trusted-proxy/analytics 采集队列）
- [√] 7.4 更新模块文档：`helloagents/wiki/modules/common.md`（internal client 支撑/HTML entity 工具）
- [√] 7.5 更新模块文档：`helloagents/wiki/modules/auth-service.md`（internal client 改造点/错误语义）
- [√] 7.6 更新运维/排障文档（如需）：补齐 trusted-proxy 与 analytics 采集排障要点（`helloagents/wiki/runbooks/*`）
