...
Directory: `helloagents/plan/202602061145_exception_handling_convergence/`
...
- [√] 7.1 更新 `helloagents/wiki/modules/common.md` 与 `helloagents/wiki/api.md`：补齐错误协议与分域错误码约定
- [√] 7.2 如 gateway 新增全局错误收敛：更新 `helloagents/wiki/modules/gateway.md`
- [√] 7.3 更新 `helloagents/CHANGELOG.md` 并将已执行方案包迁移到 `helloagents/history/YYYY-MM/`（执行阶段强制）
