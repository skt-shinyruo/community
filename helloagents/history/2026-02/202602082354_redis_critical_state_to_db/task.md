...
Directory: `helloagents/plan/202602082354_redis_critical_state_to_db/`
...
- [√] 8.1 同步更新知识库：`helloagents/wiki/modules/common.md`、`helloagents/wiki/modules/auth-service.md`、`helloagents/wiki/modules/gateway.md`（对齐默认 store 与降级策略），并在 `helloagents/CHANGELOG.md` 记录变更
