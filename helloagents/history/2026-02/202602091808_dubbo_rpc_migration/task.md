...
Directory: `helloagents/plan/202602091808_dubbo_rpc_migration/`
...
- [√] 12.1 更新 `helloagents/wiki/arch.md`：补充 Dubbo RPC 与 Zookeeper registry 架构图与说明，verify why.md#req-rpc-migration
- [√] 12.2 更新 `helloagents/wiki/api.md`：标注 internal HTTP 端点的“运维/兼容”定位，并补充 RPC 约定，verify why.md#req-api-modules
