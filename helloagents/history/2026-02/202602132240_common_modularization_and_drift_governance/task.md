...
Directory: `helloagents/plan/202602132240_common_modularization_and_drift_governance/`
...
- [√] 7.1 同步更新知识库：`helloagents/wiki/modules/common.md`（common 边界）、`helloagents/wiki/modules/infra.md`（starter/outbox）、相关服务模块文档，补齐迁移指引
