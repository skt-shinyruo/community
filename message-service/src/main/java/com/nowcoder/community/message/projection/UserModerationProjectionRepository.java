...
public class UserModerationProjectionRepository {
    ...
    public void assertCanSendMessage(int userId) {
        ...
        List<ModerationSnapshot> list = jdbcTemplate.query(
                ...
                (rs, rowNum) -> {
                    ...
                    s.muteUntil = mu == null ? null : mu.toInstant();
                    s.banUntil = bu == null ? null : bu.toInstant();
                    s.updatedAt = ua == null ? null : ua.toInstant();
                    return s;
                },
                uid
        );
    ...
    private static class ModerationSnapshot {
        private int userId;
