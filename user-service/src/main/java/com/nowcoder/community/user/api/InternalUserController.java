...
public class InternalUserController {
    ...
    public Result<InternalAuthenticateResponse> authenticate(@Valid @RequestBody InternalAuthenticateRequest request) {
    ...
    public Result<InternalSessionProfileResponse> sessionProfile(@PathVariable int userId) {
    ...
    public Result<InternalRegisterResponse> register(@Valid @RequestBody InternalRegisterRequest request) {
    ...
    public Result<InternalActivationResponse> activate(@PathVariable int userId, @Valid @RequestBody InternalActivateRequest request) {
    ...
    @GetMapping("/by-email")
    public Result<InternalUserByEmailResponse> byEmail(@RequestParam String email) {
    ...
    public Result<Void> updatePassword(@PathVariable int userId, @Valid @RequestBody InternalUpdatePasswordRequest request) {
